...
//                            }
    ...
    // 砂狼白子（骑行）
    public static final RegistryObject<Item> SHIROKO_CYCLING_HALO = ITEMS.register(
            "shiroko_cycling_halo",
            () -> new DecorationItem.Builder(
                    "shiroko_cycling_halo",
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{764}, new int[]{1019}, 135, 135, 0.0F, 0.0F, 40, 0.8F, 1.6F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 砂狼白子（泳装）
    public static final RegistryObject<Item> SHIROKO_SWIMSUIT_HALO = ITEMS.register(
            "shiroko_swimsuit_halo",
            () -> new DecorationItem.Builder(
                    "shiroko_swimsuit_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
            )
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{547}, new int[]{1525}, 135, 135, 0.0F, 0.0F, 40, 0.8F, 1.6F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 小鸟游星野（泳装）
    public static final RegistryObject<Item> HOSHINO_SWIMSUIT_HALO = ITEMS.register(
            "hoshino_swimsuit_halo",
            () -> new DecorationItem.Builder(
                    "hoshino_swimsuit_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
            )
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{866}, new int[]{1092}, 132, 132, 0.0F, 0.0F, 38, 0.7F, 0.7F, 3, 3000L, true, false
                    ))
                    .build()
    );

    // 奥空绫音（泳装）
    public static final RegistryObject<Item> AYANE_SWIMSUIT_HALO = ITEMS.register(
            "ayane_swimsuit_halo",
            () -> new DecorationItem.Builder(
                    "ayane_swimsuit_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{1094}, new int[]{1319}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 空崎日奈（礼服）
    public static final RegistryObject<Item> HINA_DRESS_HALO = ITEMS.register(
            "hina_dress_halo",
            () -> new DecorationItem.Builder(
                    "hina_dress_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            320, 192, 1.2F, 5000.0F, 0xD52B1B3D, 0xD5800040, 0xFFE6E6FA, 0xFFC8A2C8,
                            0.0F, -35.0F, false, new String[]{"dream_sakura_blue_archive:textures/screens/hina_dress.png"},
                            new int[]{973}, new int[]{1298}, 175, 175, 0.0F, 0.0F, 52, 0.8F, 0.6F, 4, 2500L, true, false
                    ))
                    .build()
    );

    // 空崎日奈（泳装）
    public static final RegistryObject<Item> HINA_SWIMSUIT_HALO = ITEMS.register(
            "hina_swimsuit_halo",
            () -> new DecorationItem.Builder(
                    "hina_swimsuit_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            320, 192, 1.2F, 5000.0F, 0xD52B1B3D, 0xD5800040, 0xFFE6E6FA, 0xFFC8A2C8,
                            0.0F, -35.0F, false, new String[]{"dream_sakura_blue_archive:textures/screens/hina_swimsuit.png"},
                            new int[]{692}, new int[]{1111}, 175, 175, 0.0F, 0.0F, 52, 0.8F, 0.6F, 4, 2500L, true, false
                    ))
                    .build()
    );

    // 天童爱丽丝（临战）
    public static final RegistryObject<Item> TENDOUARIS_BATTLE_HALO = ITEMS.register(
            "tendouaris_battle_halo",
            () -> new DecorationItem.Builder(
                    "tendouaris_battle_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
            )
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{1105}, new int[]{1300}, 130, 130, 0.0F, 0.0F, 40, 0.8F, 1.8F, 3, 1000L, true, false
                    ))
                    .build()
    );

    // 天童爱丽丝（女仆）
    public static final RegistryObject<Item> TENDOUARIS_MAID_HALO = ITEMS.register(
            "tendouaris_maid_halo",
            () -> new DecorationItem.Builder(
                    "tendouaris_maid_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
            )
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{770}, new int[]{1190}, 130, 130, 0.0F, 0.0F, 40, 0.8F, 1.8F, 3, 1000L, true, false
                    ))
                    .build()
    );

    // 白洲梓（泳装）
    public static final RegistryObject<Item> SHIRASUAZUSA_SWIMSUIT_HALO = ITEMS.register(
            "shirasuazusa_swimsuit_halo",
            () -> new DecorationItem.Builder(
                    "shirasuazusa_swimsuit_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
            )
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{978}, new int[]{1196}, 132, 132, 0.0F, 0.0F, 40, 0.75F, 1.3F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 鬼方佳代子（正月）
    public static final RegistryObject<Item> KAYOKO_NEWYEAR_HALO = ITEMS.register(
            "kayoko_newyear_halo",
            () -> new DecorationItem.Builder(
                    "kayoko_newyear_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{331}, new int[]{1291}, 132, 132, 0.0F, 0.0F, 40, 0.75F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 花冈柚子（临战）
    public static final RegistryObject<Item> YUZU_BATTLE_HALO = ITEMS.register(
            "yuzu_battle_halo",
            () -> new DecorationItem.Builder(
                    "yuzu_battle_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{591}, new int[]{1300}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 花冈柚子（女仆）
    public static final RegistryObject<Item> YUZU_MAID_HALO = ITEMS.register(
            "yuzu_maid_halo",
            () -> new DecorationItem.Builder(
                    "yuzu_maid_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{648}, new int[]{1080}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 柚鸟夏（乐队）
    public static final RegistryObject<Item> NATSU_BAND_HALO = ITEMS.register(
            "natsu_band_halo",
            () -> new DecorationItem.Builder(
                    "natsu_band_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{432}, new int[]{1239}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 伊落玛丽（偶像）
    public static final RegistryObject<Item> MARI_IDOL_HALO = ITEMS.register(
            "mari_idol_halo",
            () -> new DecorationItem.Builder(
                    "mari_idol_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{514}, new int[]{1310}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 伊落玛丽（体操服）
    public static final RegistryObject<Item> MARI_GYM_HALO = ITEMS.register(
            "mari_gym_halo",
            () -> new DecorationItem.Builder(
                    "mari_gym_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{842}, new int[]{1303}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 圣园圣娅（泳装）
    public static final RegistryObject<Item> SEIA_SWIMSUIT_HALO = ITEMS.register(
            "seia_swimsuit_halo",
            () -> new DecorationItem.Builder(
                    "seia_swimsuit_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{656}, new int[]{1400}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 才羽绿（女仆）
    public static final RegistryObject<Item> MIDORI_MAID_HALO = ITEMS.register(
            "midori_maid_halo",
            () -> new DecorationItem.Builder(
                    "midori_maid_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{704}, new int[]{1058}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );

    // 才羽桃井（女仆）
    public static final RegistryObject<Item> MOMOI_MAID_HALO = ITEMS.register(
            "momoi_maid_halo",
            () -> new DecorationItem.Builder(
                    "momoi_maid_halo",
                    new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
                    ...
                    .withTooltipTextureConfig(new com.core.dream_sakura.api.tooltip.DreamSakuraTooltipAPI.DreamSakuraTextureConfig(
                            ...
                            new int[]{877}, new int[]{1236}, 132, 132, 0.0F, 0.0F, 40, 0.8F, 1.2F, 3, 2000L, true, false
                    ))
                    .build()
    );
